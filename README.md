...
2. **Möglichkeit 2:** Europa-Anteil im MSCI World erhöhen
   ...
   2. Gewichtung SOLL nach BIP
      ...
      ![gewichtung-soll-bip](images/gewichtung-soll-bip.png)

   3. Zielbild

      > Anteil Europas verdoppeln

      ![gesamtantei-europa-40](images/gesamtanteil-europa-40.png)

   4. Beibehalten des 70:30 Konzepts

      > 70% Industrieländer, 30% Schwellenländer

      ![70-30-konzept-beibehalten](images/70-30-konzept-beibehalten.png)
...
![europa-indizes](images/europa-indizes.png)

- MSCI Europe: 15 Länder, 500 Unternehmen
  ![msci-europe.png](images/msci-europe.png)
